...
public class SpringAopAnalysis {
    ...
    protected final synchronized AopProxy createAopProxy() {
        ...
        // 而ProxyCreatorSupport继承了AdvisedSupport，因而可以当做参数传进去，
        // 最终调用工厂类AopProxyFactory依据配置信息(this)创建一个AopProxy
    ...
    public List<Object> getInterceptorsAndDynamicInterceptionAdvice(Method method, Class<?> targetClass) {
        ...
        if (cached == null) {
             ...
             * Advice都封装成MethodInteceptor，然后添加到List中从而形成拦截器链。
             */
    ...
    class ReflectiveMethodInvocation {
        ...
        public Object proceed() throws Throwable {
             ...
             * 大家可能比较疑惑，这里为什么是interceptorsAndDynamicMethodMatchers.size() - 1，因为这里的currentInterceptorIndex是从-1开始的，
             * 如果从0开始的话，那么，显然就没有后面的 - 1
             */
