package com.xu.rpc.parallel;

import com.xu.rpc.core.RpcConfig;
import com.xu.rpc.parallel.policy.AbortPolicy;
import com.xu.rpc.parallel.policy.BlockingPolicy;
import com.xu.rpc.parallel.policy.CallerRunsPolicy;
import com.xu.rpc.parallel.policy.DiscardedPolicy;
import com.xu.rpc.parallel.policy.RejectedPolicyType;
...
public class RpcThreadPool {
    ...
    private static RejectedExecutionHandler createPolicy() {
        ...
        RejectedPolicyType rejectedPolicyType = RejectedPolicyType.fromString(
                System.getProperty(RpcConfig.SYSTEM_PROPERTY_THREADPOOL_REJECTED_POLICY_ATTR, "AbortPolicy"));
    ...
    private static BlockingQueue<Runnable> createBlockingQueue(int queues) {
        ...
        BlockingQueueType queueType = BlockingQueueType.fromString(
                System.getProperty(RpcConfig.SYSTEM_PROPERTY_THREADPOOL_QUEUE_NAME_ATTR, "LinkedBlockingQueue"));

        switch (queueType) {
            case LINKED_BLOCKING_QUEUE:
                return new LinkedBlockingQueue<>();
            case ARRAY_BLOCKING_QUEUE:
                return new ArrayBlockingQueue<>(RpcConfig.SYSTEM_PROPERTY_PARALLEL * queues);
